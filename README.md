...
- ΓΛΩΣΣΑ:
    Όταν στην Γ' Λυκείου, δεν έβρισκα πουθενά κάποιο πρόγραμμα που να μεταγλωτίζει σε `*.exe`/`*.out` προγράμματα στην γλώσσα, σαν τις υπόλοιπες γλώσσες προγραμματισμού.
...
- C++:
    Είναι η πρώτη μου γλώσσα προγραμματισμού που έχω μάθει. Ο κυριότερος λόγος είναι ότι η γλώσσα αυτή μεταγλωτίζεται, ενώ η Python για παράδειγμα είναι γλώσσα διερμηνέα. Επίσης είναι γρήγορη και έχει κάποιες ακόμα λειτουργίες που η Python δεν έχει.
